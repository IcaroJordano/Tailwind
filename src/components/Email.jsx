...
export function Email() {
    return (
        <div className=" w-11/12 lg:w-10/12  rounded-2xl pl-5 pt-5 border-solid border dark:border-neutral-300/50 border-neutral-600/50">
            <h2 className="flex items-center text-slate-100 font-bold text-sm dark:text-neutral-800"><MdOutlineMailOutline className="w-7 mr-3 scale-150 text-neutral-600" ></MdOutlineMailOutline> Stay up to date</h2>
